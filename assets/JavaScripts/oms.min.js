...
(function () {
    ...
    this.OverlappingMarkerSpiderfier = (function () {
        ...
        c.trackMarker = function (a, d) {
            ...
            this.s.push(b);
            this.a.push(a);
            this.basicFormatEvents ? this.trigger('format', a, this.constructor.markerStatus.UNSPIDERFIED) : (this.trigger('format', a, this.constructor.markerStatus.UNSPIDERFIABLE), this.h());
            return this;
        };
        c.D = function (a, d) {
        ...
        c.L = function (a, d) {
            ...
            f = x / a;
            c = [];
            for (b = e = 0; 0 <= a ? e < a : e > a; b = 0 <= a ? ++e : --e) (b = this.circleStartAngle + b * f), c.push(new h.Point(d.x + g * Math.cos(b), d.y + g * Math.sin(b)));
            return c;
        };
        c.M = function (a, d) {
            var b, f, e, c, k;
        ...
        c.V = function (a, d) {
            ...
            if (q || this.map.getStreetView().getVisible() || 'GoogleEarthAPI' === this.map.getMapTypeId()) return this.trigger('click', a, d);
            q = [];
            n = [];
        ...
        c.F = function () {
            ...
            p = [];
            h = 0;
            for (d = e.length; h < d; h++) (f = e[h]), p.push({ H: this.f(null != (a = null != (b = f._omsData) ? b.v : void 0) ? a : f.position), b: !1 });
            h = this.a;
            a = b = 0;
        ...
        c.P = function (a) {
            return {
                m: (function (d) {
                    return function () {
                        return a._omsData.o.setOptions({ strokeColor: d.legColors.highlighted[d.map.mapTypeId], zIndex: d.highlightedLegZIndex });
                    };
                })(this),
                u: (function (d) {
                    return function () {
                        return a._omsData.o.setOptions({ strokeColor: d.legColors.usual[d.map.mapTypeId], zIndex: d.usualLegZIndex });
                    };
                })(this),
            };
        };
            ...
            b = function () {
                ...
                for (d = g.length; b < d; b++)
                    (e = g[b]),
                        ...
                        (n = p.R),
                        (q = new h.Polyline({ map: this.map, path: [n.position, c], strokeColor: this.legColors.usual[this.map.mapTypeId], strokeWeight: this.legWeight, zIndex: this.usualLegZIndex })),
                        (n._omsData = { v: n.getPosition(), X: n.getZIndex(), o: q }),
                        this.legColors.highlighted[this.map.mapTypeId] !== this.legColors.usual[this.map.mapTypeId] && ((k = this.P(n)), (n._omsData.O = { m: l.addListener(n, 'mouseover', k.m), u: l.addListener(n, 'mouseout', k.u) })),
    ...
    if (null != m && (m = null != (w = m.getAttribute('src')) ? (null != (y = w.match(t)) ? y[3] : void 0) : void 0) && 'function' === typeof window[m]) window[m]();
